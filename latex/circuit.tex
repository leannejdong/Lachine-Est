...
First, why? Check \href{https://medium.com/@vardanator/why-cs-students-must-learn-c-as-their-main-programming-language-6d3b4f8720bd}{\beamergotobutton{Why CS student must learn C++ as their main language}}. C++ was invented by computer scientist Bjarne Stroustrup. It is a languages that was created to fit for humans for all domains. 
