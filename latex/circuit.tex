...
\begin{frame}{Traverse information in a Graph: DFS vs BFS}
	\begin{table}[h!]
		...
		\end{center}
	\end{table}
Check our \href{https://github.com/haophancs/simple-graph-tool}{\beamergotobutton{simple-graph-tool}} for demonstration of DFS and BFS traversal
\end{frame}
\begin{frame}[shrink=5]{ Methods of finding cycle bases/Loop detection: Constructing spanning tree}
\begin{itemize}
	...
	\item Every fundamental cycle form a cycle basis. The set of all fundamental cycles forms a cycle bases. See \href{http://www.math.cmu.edu/~mradclif/teaching/241F18/CycleBases.pdf}{\beamergotobutton{Tutorial}}
	...
	\item DFS is preferred for efficiency: each node differs by only one edge from the main branch. Check tutorial \href{http://courses.ics.hawaii.edu/ReviewICS241/morea/trees/SpanningTrees-QA.pdf}{\beamergotobutton{here}}.
\end{itemize}
...
\begin{frame}{Method: \href{https://dl.acm.org/doi/pdf/10.1145/363848.363861}{Gotlieb and Corneil (1967)}}
	...
	\begin{itemize}
		...
		\begin{enumerate}
			...
			\item For rach row $i$ of A, set $b_{ji}=b_{ij}=1$ if $a_{ij}$ is the first {\color{red}superdiagonal} element of the $i$th row of $A$ to equal 1; otherwise set $b_{ji}=b_{ij}=0$.
			\begin{enumerate}
...
\begin{itemize}
	...
	\item Join the componets by adding appropriate edges to yield a spanning tree.
...
First, why? Check \href{https://medium.com/@vardanator/why-cs-students-must-learn-c-as-their-main-programming-language-6d3b4f8720bd}{\beamergotobutton{Why CS student must learn C++ as their main language}}. C++ was invented by computer scientist Bjarne Stroustrup. It is a languaged that was created to fit for humans for all domains. 
