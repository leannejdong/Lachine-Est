...
\href{boost.org/doc/libs/1_46_0/boost/graph/tiernan_all_cycles.hpp}{\beamergotobutton{tiernan\_all\_cycles.hpp}}
and \href{boost.org/doc/libs/1_46_1/libs/graph/example/tiernan_print_cycles.cpp}{\beamergotobutton{tiernan\_print\_cycles.cpp}} we could find independent set of cycles, each cycle will then give us an equation. The set of cycles yield a system of equations.
\end{itemize}
...
% \begin{frame}[fragile,shrink=30]{Creating adjacency matrix}
% \begin{minted}{c++}
% #include <iostream>
% #include <vector>
% #include <utility>
...
% \begin{frame}{Creating incidence matrix}
% \begin{minted}{c++}
% #include<iostream>
% #include<vector>
% #include<utility>
